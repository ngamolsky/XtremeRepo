...
const AuthForm: React.FC = () => {
  ...
  const validateEmail = (email: string) => {
    return email.endsWith('@xtreme-falcons.com');
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateEmail(email)) {
      setError('Please use your @xtreme-falcons.com email address');
      setLoading(false);
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Xtreme Falcons</h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="your.name@xtreme-falcons.com"
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors"
                  required
                />
              </div>
              <p className="text-xs text-gray-500 mt-1">
                Must be an @xtreme-falcons.com email address
              </p>
            </div>
